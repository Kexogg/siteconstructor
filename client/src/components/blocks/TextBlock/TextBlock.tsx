...
import {useInlineCustomColors} from "../../../hooks/useInlineCustomColors";

const TextBlock = ({data}: {data: TextBlockProps}) => {
    return (
        <section style={useInlineCustomColors(data.jsonb.styles)} className={'bg-user-background text-user-text'}>
